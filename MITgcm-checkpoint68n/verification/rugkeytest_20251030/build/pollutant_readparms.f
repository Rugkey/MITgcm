...
C     Set default values
       ...
       pollutant_decay_rate = 0.D0
       pollutant_settle_rate = 0.D0
       pollutant_biouptake_rate = 0.D0
       pollutant_monFreq = 86400.D0
...
C--   Validate forcing parameters
      IF ( pollutant_forcingCycle .LT. 0.D0 ) THEN
     ...
     &    'pollutant_forcingCycle must be >= 0'
      ...
      IF ( pollutant_forcingPeriod .LT. 0.D0 ) THEN
        WRITE(msgBuf,'(2A)') 'POLLUTANT_READPARMS: ',
     &    'pollutant_forcingPeriod must be >= 0'
      ...
      IF ( pollutant_forcingCycle .GT. 0.D0 .AND.
     &     pollutant_forcingPeriod .GT. 0.D0 ) THEN
...
C--   Validate rate parameters
      IF ( pollutant_decay_rate .LT. 0.D0 ) THEN
        WRITE(msgBuf,'(2A)') 'POLLUTANT_READPARMS: ',
     &    'pollutant_decay_rate must be >= 0'
      ...
      IF ( pollutant_settle_rate .LT. 0.D0 ) THEN
        WRITE(msgBuf,'(2A)') 'POLLUTANT_READPARMS: ',
     &    'pollutant_settle_rate must be >= 0'
      ...
      IF ( pollutant_biouptake_rate .LT. 0.D0 ) THEN
        WRITE(msgBuf,'(2A)') 'POLLUTANT_READPARMS: ',
...
C--   Validate monitor frequency
      IF ( pollutant_monFreq .LT. 0.D0 ) THEN
        WRITE(msgBuf,'(2A)') 'POLLUTANT_READPARMS: ',
