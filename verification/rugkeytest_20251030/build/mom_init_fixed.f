...
C               coeff. for mixing of momentum horizontally ( units of m^4/s )
     ...
     &                  viscA4Dfld, viscA4Zfld
      Real*8  viscA4Dfld (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8  viscA4Zfld (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      ...
      DO bj=myByLo(myThid), myByHi(myThid)
       DO bi=myBxLo(myThid), myBxHi(myThid)
         ...
         DO k=1,Nr
          DO j=1-OLy,sNy+OLy
           DO i=1-OLx,sNx+OLx
            viscA4Dfld(i,j,k,bi,bj) = 0.D0
            viscA4Zfld(i,j,k,bi,bj) = 0.D0
           ENDDO
          ENDDO
         ENDDO
