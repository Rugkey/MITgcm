...
C     !LOCAL VARIABLES:
      ...
      Real*8 decayTerm, settleTerm, bioupTerm
      Real*8 local_decay_rate, temp_factor, depth_factor
      Real*8 pTr_Pollutant_safe, mass
      Real*8 denom
CEOP
