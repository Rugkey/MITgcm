...
C     pollutant_fluxIsCellTotal :: if .TRUE., input emission is mol/s per grid-cell
     ...
     &              pollutant_emission_file
      ...
      Real*8 pollutant_Tc
      Real*8 pollutant_k_dark_20_d
      Real*8 pollutant_Q10_dark
      Real*8 pollutant_k_bio_20_d
      Real*8 pollutant_Q10_bio
      Real*8 pollutant_k_OH_d
      Real*8 pollutant_k_photo_d
      Real*8 pollutant_light_atten
      Real*8 pollutant_k_dark_20
      Real*8 pollutant_k_bio_20
      Real*8 pollutant_k_OH
      Real*8 pollutant_k_photo
...
C     pollutant_ldRec :: time-record currently loaded
     ...
     &        pollutant_flux0, pollutant_flux1
      Real*8 pollutant_flux0(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 pollutant_flux1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
...
C     *==========================================================*
     ...
     &      pollutant_swdown
      Real*8 pollutant_swdown(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
...
C     == Local variables ==
      ...
      Real*8 k_total, k_dark_T, k_bio_T, k_photo_z
      Real*8 temp_factor_dark, temp_factor_bio
      Real*8 light_factor
      Real*8 conc
      Real*8 denom
...
C               a) Temperature-dependent dark and biological degradation (Q10)
     ...
     &              ( (theta(i,j,k,bi,bj) - 20.0D0) / 10.0D0 )
...
C               b) Depth-dependent direct photolysis (Beer-Lambert law)
                k_photo_z = 0.D0
                IF ( pollutant_swdown(i,j,bi,bj) .GT. 0.D0 ) THEN
