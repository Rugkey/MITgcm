...
C     pollutant_biouptake_rate  :: bio-uptake rate constant
     ...
     &              pollutant_biouptake_halflife_d
      ...
      Real*8 decayTempRef
      Real*8 decayQ10
      Real*8 decayDepthScale
      Real*8 pollutant_decay_halflife_d
      Real*8 pollutant_settle_halflife_d
      Real*8 pollutant_biouptake_halflife_d
...
C     == Local variables ==
      ...
      Real*8 sourceTerm
      Real*8 decayTerm, settleTerm, bioupTerm, sinkTerm
      Real*8 local_decay_rate, temp_factor, depth_factor
      Real*8 conc
      Real*8 denom
...
C     Work arrays for block diagnostics fill
      ...
      Real*8 massDiag  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
...
C          2) Sinks
            conc = MAX( 0.D0, pTracer(i,j,k,bi,bj,POLLUTANT_pTr_i1) )
            decayTerm  = 0.D0
            settleTerm = 0.D0
            bioupTerm  = 0.D0
