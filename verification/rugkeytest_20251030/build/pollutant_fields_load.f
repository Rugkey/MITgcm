...
C     sh        :: wind-speed [m/s] (always larger than uMin)
      ...
      Real*8 tidePot   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 tidePot0  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 tidePot1  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
...
C--   Load pollutant emission forcing
     ...
     &                         pollutant_flux1, intime1, 1, myThid )
          ...
          CALL EXCH_XY_RL (  pollutant_flux0,  myThid  )
          CALL EXCH_XY_RL (  pollutant_flux1,  myThid  )
