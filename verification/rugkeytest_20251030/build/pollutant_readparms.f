...
C--   Set default values
       ...
       pollutant_decay_halflife_d     = 0.D0
       pollutant_settle_halflife_d    = 0.D0
       pollutant_biouptake_halflife_d = 0.D0

       pollutant_forcingPeriod = externForcingPeriod
       pollutant_forcingCycle  = externForcingCycle
       decayTempRef            = 20.D0
       decayQ10                = 2.0D0
       decayDepthScale         = 50.D0
...
C     k = ln(2) / T_half
      LOG_2 = 0.69314718056D0
      SECONDS_PER_DAY = 86400.D0

      IF ( pollutant_decay_halflife_d .GT. 0.D0 ) THEN
     ...
     &     ( pollutant_decay_halflife_d * SECONDS_PER_DAY )
      ...
      IF ( pollutant_settle_halflife_d .GT. 0.D0 ) THEN
     ...
     &     ( pollutant_settle_halflife_d * SECONDS_PER_DAY )
      ...
      IF ( pollutant_biouptake_halflife_d .GT. 0.D0 ) THEN
...
C---+----1----+----2----+----3----+----4----+----5----+----6----+----7-|--+----|
      ...
      IF ( pollutant_decay_halflife_d .LT. 0.D0 ) THEN
     ...
     &    'pollutant_decay_halflife_d must be >= 0'
      ...
      IF ( pollutant_settle_halflife_d .LT. 0.D0 ) THEN
        WRITE(msgBuf,'(2A)') 'POLLUTANT_READPARMS: ',
     &    'pollutant_settle_halflife_d must be >= 0'
      ...
      IF ( pollutant_biouptake_halflife_d .LT. 0.D0 ) THEN
        WRITE(msgBuf,'(2A)') 'POLLUTANT_READPARMS: ',
