...
C  arrUin      ( Real*8 )   :: 1rst component input field array (loaded from file)
C  arrVin      ( Real*8 )   :: 2nd  component input field array (loaded from file)
...
C     msgBuf      :: Informational/error message buffer
      Real*8      csLon(-1:exf_max_nLon+2), snLon(-1:exf_max_nLon+2)
      Real*8      x_in (-1:exf_max_nLon+2), y_in (-1:exf_max_nLat+2)
