       ...
       DO bi = myBxLo(myThid), myBxHi(myThid)
        DO j = 1-OLy, sNy+OLy
         DO i = 1-OLx, sNx+OLx
          ...
          pollutant_flux0(i,j,bi,bj) = 0.D0
          pollutant_flux1(i,j,bi,bj) = 0.D0
         ENDDO
        ENDDO
